...
def stockNeural(filename):
    ...
    netfile = 'data/neuralModels/'+filename+'/'+'netRSI.model'  # 构建的神经网络模型存储路径
    ...
    if os.path.exists('data/neuralModels/'+filename+'/netRSI.model'):
    ...
    csvfile = file('data/modelPredict/' + filename+'/'+'resultPredictRSI.csv', 'wb')
